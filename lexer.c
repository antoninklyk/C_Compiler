...
/**
 * 
 * @brief lexical analysis function
 * 
 *  */
int lex(struct lex_process *process)
{
    ...
    lex_process = process; // pour traiter la variable lex_process en locale, et pas traiter la variable globale process en locale      
